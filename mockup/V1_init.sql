...
insert into specification (id, name, name_en,active, quick_show, priority, specification_group_id) values (2, 'Kích thước lọt lòng thùng (D x R x C)', 'Inside cargo box dimension',1, 1, 2, 1);
insert into specification (id, name, name_en,active, quick_show, priority, specification_group_id) values (3, 'Vệt bánh trước/Sau', 'Front/Rear tread',1, 0, 3, 1);
insert into specification (id, name, name_en,active, quick_show, priority, specification_group_id) values (4, 'Chiều dài cơ sở', 'Wheelbase',1, 0, 4, 1);
insert into specification (id, name, name_en,active, quick_show, priority, specification_group_id) values (5, 'Khoảng sáng gầm xe', 'Ground clearance',1, 0, 5, 1);
...
insert into specification (id, name, name_en,active, quick_show, priority, specification_group_id) values (7, 'Tải trọng', 'Load weight',1, 1, 2, 2);
insert into specification (id, name, name_en,active, quick_show, priority, specification_group_id) values (8, 'Trọng lượng toàn bộ', 'Gross weight',1, 0, 3, 2);
insert into specification (id, name, name_en,active, quick_show, priority, specification_group_id) values (9, 'Số chỗ ngồi', 'Number of seats',1, 0, 4, 2);
...
insert into specification (id, name, name_en,active, quick_show, priority, specification_group_id) values (11, 'Loại', 'Type',1, 0, 2, 3);
insert into specification (id, name, name_en,active, quick_show, priority, specification_group_id) values (12, 'Dung tích xilanh', 'Displacement',1, 0, 3, 3);
insert into specification (id, name, name_en,active, quick_show, priority, specification_group_id) values (13, 'Đường kính x Hành trình piston', 'Diameter x Piston stroke',1, 0, 4, 3);
insert into specification (id, name, name_en,active, quick_show, priority, specification_group_id) values (14, 'Công suất cực đại/Tốc độ quay', 'Max power/Rotation speed',1, 0, 5, 3);
insert into specification (id, name, name_en,active, quick_show, priority, specification_group_id) values (15, 'Mômen xoắn cực đại/Tốc độ quay', 'Max torque/Rotation speed',1, 0, 6, 3);
...
insert into specification (id, name, name_en,active, quick_show, priority, specification_group_id) values (17, 'Số tay', 'Manual',1, 0, 2, 4);
...
insert into specification (id, name, name_en,active, quick_show, priority, specification_group_id) values (21, 'Sau', 'Rear',1, 0, 2, 7);
...
insert into specification (id, name, name_en,active, quick_show, priority, specification_group_id) values (25, 'Bán kính quay vòng nhỏ nhất', 'Minimum turning radius',1, 0, 2, 9);
insert into specification (id, name, name_en,active, quick_show, priority, specification_group_id) values (26, 'Tốc độ tối đa', 'Maximum speed',1, 0, 3, 9);
insert into specification (id, name, name_en,active, quick_show, priority, specification_group_id) values (27, 'Dung tích thùng nhiên liệu', 'Capacity fuel tank',1, 0, 4, 9);
...
insert into specification (id, name, name_en,active, quick_show, priority, specification_group_id) values (29, 'KHÓA CỬA AN TOÀN', 'lock door',1, 0, 2, 10);
insert into specification (id, name, name_en,active, quick_show, priority, specification_group_id) values (30, 'THANH GiẢM CHẤN', 'Damping',1, 0, 3, 10);
insert into specification (id, name, name_en,active, quick_show, priority, specification_group_id) values (31, 'ĐÈN BÁO PHANH', 'Brake lights',1, 0, 4, 10);
insert into specification (id, name, name_en,active, quick_show, priority, specification_group_id) values (32, 'CHỐNG TRỘM', 'Burglar',1, 0, 5, 10);
